...
<head>
  ...
  <title>BYD Indonesia | Login Account</title>
  <link rel="icon" type="image/x-icon" href="logo-byd.ico">
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="" class="h1"><b>Login</b>&nbsp;Account</a>
    </div>
    <div class="card-body">
      ...
      <p class="mb-1">
        <a href="recovery.php">I forgot my password</a>
      </p>
      <p class="mb-0">
